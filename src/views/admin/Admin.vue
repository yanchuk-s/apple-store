      ...
      <div class="container">
        <div class="dflex">
          ...
          <div class="logout-wrp">
            <button @click="logout">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 511.989 511.989" style="enable-background:new 0 0 511.989 511.989;" xml:space="preserve" width="512" height="512" class=""><g><g>
                  <g>
                    <g>
                      <path d="M110.933,221.782c-4.71,0-8.533,3.823-8.533,8.533v51.2c0,4.71,3.823,8.533,8.533,8.533s8.533-3.823,8.533-8.533v-51.2     C119.467,225.605,115.644,221.782,110.933,221.782z" data-original="#000000" class="active-path" style="fill:#000000"></path>
