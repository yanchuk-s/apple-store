<template>
  <div>
    ...
    <div class="add-prod-wrp-btn">
        <v-btn @click="saveEdid">Save</v-btn>
    </div>
  </div>
</template>
...
export default {
  ...
  created(){
    ...
    let product = this.$store.getters.getProductById(this.$route.params.id)
    let categoryTitle = this.$store.getters.getCategoryById(product.category)

    this.title = product.title
    this.price = product.price
    this.category = categoryTitle.title
